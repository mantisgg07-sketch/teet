  ...
  try {
    ...
    for (const column of columnsToAdd) {
      ...
      if (!existingColumns.includes(columnName)) {
        ...
        console.log(`[OK] Added column: ${columnName}`);
      } else {
    ...
    for (const tour of tours.rows) {
      if (tour.title && !tour.title_en) {
        ...
        console.log(`[OK] Migrated tour #${tour.id} to English fields`);
      }
    }
    ...
    for (const announcement of announcements.rows) {
      if (announcement.message && !announcement.message_en) {
        ...
        console.log(`[OK] Migrated announcement #${announcement.id} to English field`);
      }
    }

    console.log('\n[DONE] Multilingual migration completed successfully!');
    console.log('\nNext steps:');
